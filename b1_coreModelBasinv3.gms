...
*NEW WATER CONSTRAINTS
   ...
   e_water33      "water constraint Concepción"
...
*NEW WATER not used
   ...
   e_watNU33      "water constraint Concepción"
...
e_water33('Concepción')..  FW2('Concepción') =L= W0_a('Concepción')*p_hda('Concepción')+ W0_r('Concepción')*p_hdr('Concepción')+WNU2('Chiguayante')*p_hdra('Concepción');
...
e_water36('Hualpen')..  FW2('Hualpen') =L= W0_a('Hualpen')*p_hda('Hualpen')+ W0_r('Hualpen')*p_hdr('Hualpen')+WNU2('San_Pedro_de_la_Paz')*p_hdra('Hualpen')+WNU2('Concepción')*p_hdra('Hualpen');
...
e_watNU33('Concepción')..      WNU2('Concepción')$(p_hda('Concepción') gt 0) =E= DW0('Concepción') - (FW4('Concepción')/p_hda('Concepción')+FW3('Concepción')/p_hdr('Concepción'))+WNU2('Chiguayante');
...
e_watNU36('Hualpen')..      WNU2('Hualpen')$(p_hda('Hualpen') gt 0) =E= DW0('Hualpen') - (FW4('Hualpen')/p_hda('Hualpen')+FW3('Hualpen')/p_hdr('Hualpen'))+WNU2('San_Pedro_de_la_Paz')+WNU2('Concepción');
